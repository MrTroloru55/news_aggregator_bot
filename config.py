...
with open('C:\\Users\\user\\Desktop\\paperboy\\token_paperboy.txt', 'r') as file:
    BOT_TOKEN = file.readline().strip()
    
with open('C:\\Users\\user\\Desktop\\paperboy\\API_ID_paperboy.txt', 'r') as file:
    API_ID = file.readline().strip()
    
with open('C:\\Users\\user\\Desktop\\paperboy\\API_HASH_paperboy.txt', 'r') as file:
